<div class="browse-categories bd-categories-tabs container pt-4">
  ...
  <div class="row position-relative">
    ...
    <div class="col-3">
      <div class="nav flex-column nav-pills" id="v-pills-tab">
        <div class="pill-link" id="v-pills-new-tab">
          ...
          <div class="tab-pane p-3" id="v-pills-new">
        ...
        <div class="pill-link" id="v-pills-bestsellers-tab">Bestsellers
          <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-chevron-right" viewBox="0 0 16 16">
            <path fill-rule="evenodd" d="M4.646 1.646a.5.5 0 0 1 .708 0l6 6a.5.5 0 0 1 0 .708l-6 6a.5.5 0 0 1-.708-.708L10.293 8 4.646 2.354a.5.5 0 0 1 0-.708z"/>
          </svg>
          <div class="tab-pane p-3" id="v-pills-new">
        ...
        <div class="pill-link" id="v-pills-good-tab">
        ...
        <div class="pill-link" id="v-pills-evil-tab">
        ...
        <div class="pill-link" id="v-pills-scenery-tab">
    ...
    <div class="col-9 ps-0 position-relative">
